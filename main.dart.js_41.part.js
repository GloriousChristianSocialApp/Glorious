...
aDr(d,e){return new A.I(d.a+e.a,Math.max(d.b,e.b))},
bht(d){return d.gt(0)},
bhu(d,e){var x=e.b
x.toString
y.e.a(x).a=d},
...
this.b=1
this.c=e},
nk:function nk(d,e,f){this.cS$=d
this.ao$=e
this.a=f},
Ih:function Ih(d,e,f,g,h,i,j,k,l,m,n,o,p,q,r){var _=this
_.p=d
_.Z=e
_.T=f
_.a8=g
...
a7B:function a7B(){},
a7C:function a7C(){},
aYB(d,e,f){return new B.a0A(f,e,d,null)},
...
Er(d,e,f,g){var x,w,v=this
$label0$0:{if(C.f1===v){x=new A.a_(g?d:0,e)
break $label0$0}if(C.aGQ===v){x=C.f1.Er(d,e,f,!g)
break $label0$0}w=C.aGS===v
if(w&&f<2){x=C.f1.Er(d,e,f,g)
break $label0$0}if(C.aGR===v){x=new A.a_(d/2,e)
break $label0$0}if(w){x=new A.a_(0,d/(f-1)+e)
break $label0$0}if(C.aGT===v){x=d/f
x=new A.a_(x/2,x+e)
break $label0$0}if(C.aGU===v){x=d/(f+1)
x=new A.a_(x,x+e)
break $label0$0}x=null}return x}}
B.Kx.prototype={
L(){return"WrapCrossAlignment."+this.b},
gamg(){switch(this.a){case 0:var x=C.aGV
break
case 1:x=C.qN
break
case 2:x=C.aGW
break
default:x=null}return x},
gai5(){switch(this.a){case 0:var x=0
break
case 1:x=1
break
case 2:x=0.5
...
default:x=null}return x}}
B.NZ.prototype={
aMu(d,e,f,g,h){var x=this,w=x.a
if(w.a+e.a+g-h>1e-10)return new B.NZ(e,d)
else{x.a=B.aDr(w,B.aDr(e,new A.I(g,0)));++x.b
if(f)x.c=d
return null}}}
B.nk.prototype={}
B.Ih.prototype={
sFv(d,e){if(this.p===e)return
this.p=e
this.a1()},
seF(d){if(this.Z===d)return
this.Z=d
this.a1()},
swo(d,e){if(this.T===e)return
this.T=e
this.a1()},
saLO(d){if(this.a8===d)return
this.a8=d
this.a1()},
saLT(d){if(this.a3===d)return
this.a3=d
this.a1()},
saDm(d){if(this.ae===d)return
this.ae=d
this.a1()},
eO(d){if(!(d.b instanceof B.nk))d.b=new B.nk(null,null,D.j)},
ba(d){var x,w,v,u,t,s=this
switch(s.p.a){case 0:x=s.aa$
for(w=A.p(s).i("ai.1"),v=0;x!=null;){u=x.gbm()
...
s=B.b4V(v,d,r.p)
q.a=null
r.ZW(u,v,s,new B.avd(q,x,e),new B.ave(x))
return q.a},
cz(d){return this.azu(d)},
azu(d){var x,w,v,u,t,s,r,q,p,o,n,m,l,k,j=this
...
v=u
t=j.aa$
for(x=A.p(j).i("ai.1"),s=0,r=0,q=0,p=0,o=0;t!=null;){n=A.b0w(t,w)
m=j.an2(n)
l=j.amI(n)
...
r=s.b-w.b
q.a4=t<0||r<0
q.ZW(v,new A.I(t,r),s,B.bqv(),B.bqu())},
Wj(d,e){var x,w,v,u,t,s,r,q,p,o,n,m,l,k,j=this,i=null
switch(j.p.a){case 0:x=d.b
x=new A.a_(new A.ab(0,x,0,1/0),x)
break
case 1:x=d.d
...
p=i
o=D.K
while(q!=null){n=B.aYE(e.$2(q,w),j.p)
m=p==null
l=m?new B.NZ(n,q):p.aMu(q,n,t,s,v)
if(l!=null){r.push(l)
if(m)m=i
else{m=p.a
n=new A.I(m.b,m.a)
...
m=r.length
k=p.a
o=B.aDr(o,B.aDr(new A.I(x*(m-1),0),new A.I(k.b,k.a)))
return new A.a_(new A.I(o.b,o.a),r)},
ZW(b1,b2,b3,b4,b5){var x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3=this,a4=null,a5=a3.T,a6=Math.max(0,b2.b),a7=a3.gVe(),a8=a7.a,a9=a4,b0=a7.b
a9=b0
x=a3.ae
if(a9)x=x.gamg()
w=a3.a8.Er(a6,a3.a3,b1.length,a9)
v=w.a
u=a4
t=w.b
u=t
...
a0=B.aYE(b5.$1(f),a3.p)
a1=a4
a2=a0.b
a1=a2
b4.$2(a3.an5(d,p+x.gai5()*(m-a1)),f)
d+=a0.a+h
f=s.$1(f);--e}p+=m+u}},
cY(d,e){return this.uV(d,e)},
aQ(d,e){var x,w=this,v=w.a4&&w.ag!==D.n,u=w.aC
if(v){v=w.cx
v===$&&A.b()
x=w.gt(0)
u.saG(0,d.nL(v,e,new A.O(0,0,0+x.a,0+x.b),w.ga4h(),w.ag,u.a))}else{u.saG(0,null)
w.r4(d,e)}},
...
B.a0A.prototype={
aK(d){var x=A.dF(d)
x=new B.Ih(D.b8,C.f1,this.r,C.f1,this.x,C.qN,x,D.bn,D.n,A.ap(y.h),0,null,null,new A.aR(),A.ap(y.d))
x.aJ()
x.V(0,null)
return x},
aO(d,e){var x
...
x(B.a7B,A.ai)
w(B.a7C,A.dw)})()
A.bO(b.typeUniverse,JSON.parse('{"nk":{"ey":[],"el":["C"],"dp":[]},"Ih":{"dw":["C","nk"],"C":[],"ai":["C","nk"],"z":[],"au":[],"ai.1":"nk","dw.1":"nk","ai.0":"C"},"a0A":{"ep":[],"av":[],"h":[]}}'))
var y={a:A.L("ab"),h:A.L("mm"),d:A.L("cG"),l:A.L("r<NZ>"),e:A.L("nk")};(function constants(){C.f1=new B.rF(0,"start")
C.aGQ=new B.rF(1,"end")
C.aGR=new B.rF(2,"center")
C.aGS=new B.rF(3,"spaceBetween")
C.aGT=new B.rF(4,"spaceAround")
C.aGU=new B.rF(5,"spaceEvenly")
C.qN=new B.Kx(0,"start")
C.aGV=new B.Kx(1,"end")
C.aGW=new B.Kx(2,"center")})()};
(a=>{a["nOiCCa7v2oEO5NG12b/qcYAQj7Y="]=a.current})($__dart_deferred_initializers__);